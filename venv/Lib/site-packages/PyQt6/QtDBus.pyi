...
class QDBusObjectPath(PyQt6.sip.simplewrapper):
    ...
    def __eq__(self, rhs: 'QDBusObjectPath') -> bool: ...
    def __ne__(self, rhs: 'QDBusObjectPath') -> bool: ...
...
class QDBusSignature(PyQt6.sip.simplewrapper):
    ...
    def __eq__(self, rhs: 'QDBusSignature') -> bool: ...
    def __ne__(self, rhs: 'QDBusSignature') -> bool: ...
...
class QDBusVariant(PyQt6.sip.simplewrapper):
    ...
    def __ne__(self, v2: 'QDBusVariant') -> bool: ...
    def __eq__(self, v2: 'QDBusVariant') -> bool: ...
